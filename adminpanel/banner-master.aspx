<%@ Page Title="Banner Master | Samrudhhi Cleaning Ware" Language="C#" MasterPageFile="~/adminpanel/MasterAdmin.master" AutoEventWireup="true" CodeFile="banner-master.aspx.cs" Inherits="adminpanel_banner_master" %>
		...
		<div class="formPanel table-responsive-md">
			<asp:GridView ID="gvbanner" runat="server" CssClass="table table-striped table-bordered table-hover" GridLines="None" 
				...
				<Columns>
					 ...
					 <asp:BoundField DataField="BannerImage" HeaderText="Image Name">
						<ItemStyle Width="30%" />
					</asp:BoundField>

					 <asp:BoundField DataField="BannerOrder" HeaderText="Display Order">
						<ItemStyle Width="10%" />
					</asp:BoundField>
