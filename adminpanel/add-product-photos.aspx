<%@ Page Title="Add Products Photos | Samrudhhi Cleaning Ware" Language="C#" MasterPageFile="~/adminpanel/MasterAdmin.master" AutoEventWireup="true" CodeFile="add-product-photos.aspx.cs" Inherits="adminpanel_add_product_photos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h2 class="pgTitle">Add Products Photos </h2>
    <span class="titlecolor"><%= productname %></span> 
    ...
    <div id="editinfo" runat="server">
        <div class="card card-primary">
            ...
            <div class="form-group col-md-6">
                ...
                <span class="space10"></span>
                <%= productPhoto %><span class="space5"></span>
