<%@ Page Title="News | Samrudhhi Cleaning Ware" Language="C#" MasterPageFile="~/adminpanel/MasterAdmin.master" AutoEventWireup="true" CodeFile="news.aspx.cs" Inherits="adminpanel_news" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<div id="viewNews" runat="server">
		<a href="news.aspx?action=new" runat="server" class="btn btn-primary btn-md">Add New</a>
